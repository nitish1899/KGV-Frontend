...
const ProductComparison2 = ({ navigation, route }) => {
    ...
    return (
        <LinearGradient colors={['#545a2c', "#FFF"]} style={styles.gradient}>
            ...
            <Text style={styles.title}>Why KGV ?2</Text>
            ...
            <TouchableOpacity
                style={styles.button}
                onPress={() => navigation.navigate('Visitorcomparechart2', { vehicleno, user })}
            >
...
const styles = StyleSheet.create({
    ...
    container: {
        flex: 1,
        padding: width * 0.01,  // Adjust padding based on screen width
    },
    logo: {
        width: width * 1.4, // 80% of the screen width
        height: height * 0.98, // 40% of the screen height
        alignSelf: 'center',
        // marginLeft: -width * 0.00145, // Responsive margin
...
export default ProductComparison2;
