...
const SummaryCart2 = ({ route, navigation }) => {
    ...
    useEffect(() => {
        axios.get(`https://kgvapp.pureprakruti.com/api/v1/visitor/details/${userId}`)
            .then(response => {
    ...
    const handleContinueToPayment = () => {
        navigation.navigate('BookingKit2', { visitorId: userId, totalItems: totalItems, totalPrice, cartId, user });
    };
    ...
    return (
        <LinearGradient colors={['#545a2c', '#FFF']} style={styles.gradient}>
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.heading}>Order Summary 2</Text>
