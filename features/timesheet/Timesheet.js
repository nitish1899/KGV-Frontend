...
export function Timesheet() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch('http://localhost:8005/api/v1/timesheet/register', {
        method: 'POST',
      ...
      if (response.ok) {
        ...
        console.log("Error saving user sheet");
      }
    }
    catch (error) {
    ...
    // const response = await fetch("http://localhost:8005/api/v1/timesheetregister", {
    //     method: "POST",
    //     body: form,
    // try {
    //   const response = await fetch("http://localhost:8005/api/v1/timesheetregister", {
  ...
  const handleSubmitManager = async (e) => {
    ...
    //   try {
    //     const response = await fetch('http://localhost:8005/api/v1/manager/rate',{
    //     method: 'POST',
    ...
    //       } else {
    //         console.log("Error rating employee");
    //       }
    // }
    //   catch (error) {
    //       console.log("Error submitting form:", error);
