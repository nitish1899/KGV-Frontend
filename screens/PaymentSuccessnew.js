...
const PaymentSuccessnew = ({ route }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity
                style={[styles.button, { backgroundColor: isParticipated ? '#cccccc' : '#28a745' }]}
...
//             <TouchableOpacity style={styles.button} onPress={handleSpinFeature} disabled={isParticipated}>
//                 <Text style={styles.buttonText}>Spin The WheelOfFortune</Text>
//             </TouchableOpacity>
//         </SafeAreaView>
//     );
// };
