...
export default ({ navigation }) => {
    ...
    const handleRegister = async () => {
        try {
            const response = await fetch('https://kgv-backend.onrender.com/api/v1/visitor/signup', {
                method: 'POST',
                headers: {
...
//     const handleRegister = async () => {
//         try {
//             const response = await fetch('https://kgv-backend.onrender.com/api/v1/consumer/signup', {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
...
//                         onChangeText={(text) => handleChange('phoneNumber', text)}
//                         value={formData.phoneNumber}
//                         keyboardType='phone-pad' // Better for phone numbers
//                     />
...
//     const handleRegister = async () => {
//         try {
//             const response = await fetch('http://192.168.1.74:8005/api/v1/consumer/signup', {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
