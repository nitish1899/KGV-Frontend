            ...
            >
                ...
                <SafeAreaView style={styles.safeArea}>
                    ...
                    >
                        ...
                        <TouchableOpacity
                            style={styles.button}
                            onPress={() => navigation.navigate('Recomanded', { vehicleno, user })}
                        >
...
// const LetterByLetterText = ({ texts, carbonEmissions, savings, style }) => {
//     const [currentText, setCurrentText] = useState('');
//     const timerRef = useRef(null);

//     useEffect(() => {
//         if (carbonEmissions && savings) {
//             // Start the text animation only when carbonEmissions and savings are available
//             startTextAnimation();
//         }
...
//         };
//     }, [carbonEmissions, savings]); // Dependencies: will trigger only when these values change
...
//                 setCurrentText(prev => prev + texts[textIndex][letterIndex]);
//                 letterIndex++;
//             } else if (textIndex < texts.length - 1) {
//                 // Move to the next text after the current one is fully shown
//                 textIndex++;
//                 letterIndex = 0;
//                 setCurrentText('');
//             } else {
//                 // If all texts are fully shown, stop the animation
//                 textIndex = 0;
//                 clearInterval(timerRef.current);
//             }
//         }, 140); // Adjust speed as needed
//     };
...
//                             `${user.data.fullName}`,
//                             `Now you can save`,
//                             `${savings} with KGV Mitr`,
//                             `You also become`, 'environment saviour',
//                             `Estimated CO2 emissions`,
//                             `over 3 years: ${carbonEmissions} kg`
//                         ]}
//                         style={styles.overlayText}
//                         carbonEmissions={carbonEmissions}
//                         savings={savings}
...
//                         showsHorizontalScrollIndicator={false}
//                     >
//                         {/* <Text style={styles.vehicledetails}>Saving Calculator</Text> */}

//                         <TouchableOpacity
//                             onPress={() => setDetailsVisible(!detailsVisible)}
//                             style={styles.clickableTextContainer}
//                         >
//                             <Text style={styles.subTitle}>Estimation taken for 3 years</Text>
//                         </TouchableOpacity>
...
//         left: width * 0.15, // 15% from the left
//         zIndex: 1,
//         height: height * 0.08, // Adjusting based on screen height
//         width: width * 0.4, // Adjusting width based on screen width
//     },
//     overlayText: {
...
//         marginTop: height * 0.4, // Responsive margin from top
//     },
//     detailsContainer: {
...
//         alignItems: 'center',
//         flexDirection: 'row',
//         marginTop: height * 0.0, // Responsive margin
//         // marginBottom: height * 0.0001, // Responsive margin
...
//         height: width * 0.09, // Responsive height
//     },
//     footerTextContainer: {
//         alignItems: 'center'
//     },
...
//         height: height * 0.02, // Responsive height
//     },
//     footerLogo: {
