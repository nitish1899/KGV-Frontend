...
import { SafeAreaView, Text, TextInput, StyleSheet, View, Image, TouchableOpacity, Keyboard, Alert, Modal, Pressable, Dimensions, Animated ,ActivityIndicator} from 'react-native';
...
export default ({ navigation }) => {
    ...
    const bannerTranslateX = useRef(new Animated.Value(-50)).current; 
    const startAnimation = () => {
      ...
      const animateBanner = () => {
        Animated.timing(bannerTranslateX, {
          toValue: 0, // Move banner into view
          duration: 500,
          useNativeDriver: true,
        }).start();
      };
    ...
    const sendOtp = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('result auth',result.message);
            ...
            <SafeAreaView style={{ flex: 1, padding: 40 }} >
                    ...
                    {otpVerified && (
                        <>
                            ...
                            <DatePicker
                                ...
                                mode="date"
                                maximumDate={eighteenYearsAgo} // Restrict to 18 years before today
                                onConfirm={(date) => {
                ...
                {showBanner && (
                        <Animated.View style={{ transform: [{ translateX: bannerTranslateX }] }}>
                            <TouchableOpacity
                            className="bottom-20 w-[90%] h-13 bg-[#06264D] rounded-lg items-center justify-center p-4"
                            onPress={handleBannerClick} 
                            >
                            <Text className="text-white text-lg font-bold">Participate in contest</Text>
                            </TouchableOpacity>
                        </Animated.View>
                        )
                }
...
//     const [showBanner, setShowBanner] = useState(false);
//     const translateX = useRef(new Animated.Value(-200)).current;
//     const bannerTranslateX = useRef(new Animated.Value(200)).current; 
//     const startAnimation = () => {
//         Animated.timing(translateX, {
//           toValue: width,
//           duration: 5000,
...
//       const handleBannerClick = () => {
//         navigation.navigate('MultipleImageUpload'); // Replace 'AnotherScreen' with the actual screen name you want to navigate to
//       };
...
//             {/* {showBanner && (
//           <TouchableOpacity
//             className="absolute bottom-20 w-[90%] h-20 bg-[#06264D] rounded-lg items-center justify-center"
//             onPress={handleBannerClick} // Navigate when the banner is clicked
//           >
//             <Text className="text-white text-lg font-bold text-center">Participate The contest </Text>
//           </TouchableOpacity>
//         )} */}

// {showBanner && (
//           <Animated.View style={{ transform: [{ translateY: bannerTranslateX }] }}>
//             <TouchableOpacity
//               className="bottom-20 w-[90%] h-20 bg-[#06264D] rounded-lg items-center justify-center p-4"
//               onPress={handleBannerClick} 
//             >
//               <Text className="text-white text-lg font-bold">Participate The contest</Text>
//             </TouchableOpacity>
//           </Animated.View>
//         )}
...
// import { LinearGradient } from 'expo-linear-gradient';
// import { SafeAreaView, Text, TextInput, StyleSheet, View, Image, TouchableOpacity, Keyboard, Alert, Modal, Pressable, Dimensions } from 'react-native';
// import { Picker } from '@react-native-picker/picker';
// import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view';
// import { MaterialIcons } from '@expo/vector-icons';
// import Icon from 'react-native-vector-icons/Ionicons'; // Import Icon from react-native-vector-icons
