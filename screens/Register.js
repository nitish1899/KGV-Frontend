...
export default ({ navigation }) => {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            const response = await fetch('https://kgvapp.pureprakruti.com/api/v1/auth/signup', {
                method: 'POST',
                headers: {
    ...
    const sendOtp = async () => {
        ...
        try {
            const response = await fetch('https://kgvapp.pureprakruti.com/api/v1/auth/sendOtp', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
