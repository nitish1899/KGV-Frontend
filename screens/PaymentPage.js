...
<style>
    ...
    <div class="container">
        ...
        <div class="company-info">
            ...
            <p><strong>GSTIN:</strong> 29XXXXXXXXXXXXX</p>
        </div>
    </div>
  ...
  //   <div class="container">
  //         <img src="https://raw.githubusercontent.com/jagdish97897/weatherapp/refs/heads/main/kgv.png" alt="Image Description">
  //         <div class="text">
  //             <h1>Billing Details</h1>
  //         </div>
  //     </div>
  ...
  //   <footer>
  //     Thank you for your purchase! | For any query, contact http://kgvl.co.in/ | team@kgvl.co.in
  //   </footer>
  // `;
...
//   const totalAmount = cartItems.reduce((sum, item) => sum + item.item.totalPrice, 0);
//   const totalBookingAmount = cartItems.length * bookingAmountPerItem;
//   const totalAmountToBePaid = totalAmount - totalBookingAmount;
...
//   <p>Total Booking Amount (₹5000/kit): ₹${totalBookingAmount}</p>
//   <p>Total Amount to be Paid: ₹${totalAmountToBePaid}</p>
// `;
...
//         <View style={styles.buttonContainer}>
//           <Button title="Download PDF" onPress={generatePDF} color="#ff6347" />
//           <Button title="Proceed to Pay" onPress={handlePayment} color="#841584" disabled={true} />
//         </View>
//       </LinearGradient>
