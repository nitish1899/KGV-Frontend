  ...
  return (
    <TouchableWithoutFeedback onPress={() => setMenuVisible(false)}>
      ...
      {/* {image && <Image source={{ uri: image }} style={styles.image} onPress={pickImage}/>} */}
        ...
        <View className="bg-blue-900 rounded-3xl mx-[80px] py-4 flex items-center">
            <TouchableOpacity onPress={()=>{navigation.navigate('BookingForm')}}>
            <Text className="text-xl text-white">Book a Vechile</Text>
            </TouchableOpacity>
        </View>
        <View className="mt-[200px]">
        <Image className="h-[200px] w-[100%]" source={require("../assets/images/bookvehicle.jpg")} />
        </View>
        {/* Footer */}
        <View className="mt-[300px]" style={{ backgroundColor: 'black', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', paddingBottom: 20 }}>
          <TouchableOpacity>
